...
QtObject {
    ...
    property int colorTransitionDuration: 250
    ...
    Behavior on focusColor { ColorAnimation { duration: colorTransitionDuration; easing.type: Easing.OutCubic } }
    Behavior on primaryColor { ColorAnimation { duration: colorTransitionDuration; easing.type: Easing.OutCubic } }
    Behavior on secondaryColor { ColorAnimation { duration: colorTransitionDuration; easing.type: Easing.OutCubic } }
    Behavior on textColor { ColorAnimation { duration: colorTransitionDuration; easing.type: Easing.OutCubic } }
    Behavior on borderColor { ColorAnimation { duration: colorTransitionDuration; easing.type: Easing.OutCubic } }
    Behavior on blurOverlayColor { ColorAnimation { duration: colorTransitionDuration; easing.type: Easing.OutCubic } }
    Behavior on shadowColor { ColorAnimation { duration: colorTransitionDuration; easing.type: Easing.OutCubic } }
}
